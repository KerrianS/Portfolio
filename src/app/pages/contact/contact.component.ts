      ...
      <section class="contact-page section">
        ...
        <div class="container">
          ...
          <app-section-header
            ...
            title="Me"
            highlight="contacter"
            subtitle="Un projet en tête ? Une question ? N'hésitez pas à me contacter — je réponds sous 24h."
          ></app-section-header>
          ...
          <div class="contact-grid">
            ...
            <div class="contact-info">
              ...
              <div class="availability-card">
                ...
                <div>
                  <h4>Disponible pour de nouvelles opportunités</h4>
                  <p>À la recherche d'un poste en CDI / CDD</p>
                </div>
              </div>
            </div>
              ...
              <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="contact-form" novalidate>
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    placeholder="Ex: Opportunité CDI / CDD, Proposition d'embauche..."
                ...
                <div class="form-group">
                  ...
                  <textarea
                    ...
                    rows="6"
                    placeholder="Décrivez votre proposition ou votre message..."
...
export class ContactComponent {
  ...
  contactItems = [
    {
      id: 'email',
      label: 'Email',
      value: 'salaun.kerrian@gmail.com',
      href: 'mailto:salaun.kerrian@gmail.com',
      external: false
    },
    {
      id: 'github',
    ...
    },
    {
      id: 'linkedin',
      label: 'LinkedIn',
      value: 'linkedin.com/in/kerrian-salaün',
      href: 'https://www.linkedin.com/in/kerrian-sala%C3%BCn-b84876269/',
      external: true
    }
  ];
  ...
  isFieldInvalid(field: string): boolean {
    ...
    return !!(control && control.invalid && (this.hasSubmitted() || (control.dirty && control.touched)));
  }
